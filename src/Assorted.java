...
/*
public void addDog(Dog dog, Dog[] dogs)
{
...
public class Assorted {
    ...
    public static List<String> wildWest(List<String> directions) {
        ...
        for (String direction : directions) {
            if (!simple.isEmpty() && isOppositeDirection(direction, simple.get(simple.size() - 1))) {
                simple.remove(simple.size() - 1);
            } else {
                simple.add(direction);
            }
        }
    ...
    private static boolean isOppositeDirection(String direction1, String direction2) {
